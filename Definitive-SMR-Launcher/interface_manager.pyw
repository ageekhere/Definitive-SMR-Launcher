...
def interface_manager(os,ctk):
    ...
    __main__.error_logs(f"[interface] Setting up interface", "info")
    ...
    __main__.gUpdate_maps_button = ctk.CTkButton(__main__.gApp, text="Update maps", corner_radius=0, command=__main__.map_updater) # Update Maps Button
    ...
    if __main__.gGamePath != "":
        ...
        if __main__.os.path.exists(difficulty_path):
            __main__.error_logs(f"[interface] Loading Difficulty settings", "info")
    ...
    __main__.gInterface_canvas.create_window(25, 340, window=__main__.gGamepath_button, anchor="w")
    __main__.gInterface_canvas.create_window(25, 380, window=__main__.gGameLocation_label, anchor="w")
    ...
    __main__.gInterface_canvas.create_window(25, 420, window=__main__.gRemoveSymlink, anchor="w")
